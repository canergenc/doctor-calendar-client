...
class Locations extends Component {
    ...
    locationSetIsActive = (event, id) => {
        ...
        if (event.target.checked) {
            ...
            locationData.sortOrder = this.props.locations[1].sortOrder - 1;
            this.props.updateLocation(id, locationData);
        }
    }
                ...
                <Draggable key={location.id} draggableId={location.id} index={index}>
                    {(provided, draggableSnapshot) => (
                        ...
                        >
                            ...
                            <td>
                                <div style={{ display: "block", wordWrap: "break-word" }}>
                                    {location.name}
                                </div>
                            </td>
                            <td>
                            ...
                            <td className="color-right-resp">
                                <label
                                    className="radioLabelList"
                                    type="radioLabel"
                                    title={location.colorCode}
                                    htmlFor={location.colorCode}
                                >
                                    <span
                                        type="radioSpan"
                                        className={"radioSpanList " + location.colorCode}
                                    ></span>
                                </label>
                            </td>
                                ...
                                <UncontrolledDropdown>
                                    ...
                                    <DropdownMenu className="dropdown-menu-arrow" right>
                                        <DropdownItem
                                            ...
                                            onClick={() => this.toggleModal("editModal", location)}
                                        >
                                            Düzenle
                    </DropdownItem>
                                        <DropdownItem
                                            style={{ marginLeft: "0px" }}
                                            onClick={() => this.toggleModal("deleteModal", location)}
                                        >
                                            Kaldır
                    </DropdownItem>
                                    </DropdownMenu>
        ...
        const colorsRadioNew = listOfColorName.map((color, index) => (
            <div style={{ float: "left" }} key={index}>
                ...
                <label
                    ...
                    title={color}
                >
                    <span type="radioSpan" className={"radioSpan " + color}></span>
                </label>
            </div>
        ));
        ...
        const colorsRadioEdit = listOfColorName.map((color, index) => (
            <div style={{ float: "left" }} key={index}>
                <input
                    ...
                    value={color}
                    onChange={(event) => this.inputChangeHandle(event)}
                    checked={this.state.colorCode === color}
                />
                <label
                    className="radioLabel"
                    type="radioLabel"
            ...
            <>
                ...
                >
                            ...
                            <FormGroup>
                                <InputGroup className="input-group-alternative mb-3">
                                    <InputGroupAddon
                                        ...
                                        style={{ width: "100%" }}
                                    >
                                        <InputGroupText>Lokasyon Adı:</InputGroupText>
                                        <Input
                                            name="name"
                                            type="text"
                    ...
                    <div className="modal-footer">
                        ...
                        <Button color="primary" type="submit" onClick={this.addHandle}>
                ...
                >
                    ...
                    <div className="modal-footer">
                        ...
                        <Button color="primary" type="submit" onClick={this.updateHandle}>
                            Değişiklikleri Kaydet
            </Button>
                    </div>
                </Modal>
                ...
                >
                    ...
                    <div className="modal-body">
                        <h5>
                            Bu lokasyonu silerseniz, lokasyona bağlı oluşturulmuş nöbetler de
                    ...
                    <div className="modal-footer">
                        ...
                        <Button color="danger" type="submit" onClick={this.deleteHandle}>
                            Kaldır
            </Button>
                    </div>
                </Modal>
                                ...
                                <CardHeader className="border-0">
                                    <Row>
                                        <Col xl="10" lg="9" md="8" sm="7" xs="7">
                                            <h3 className="mb-0" style={{ display: "inline-block" }}>
                                                Lokasyon Listesi
                      </h3>
                                            <Button
                                                color="secondary"
                                    ...
                                    <Table className="align-items-center table-flush specialTableLoc">
                                        <thead className="thead-light">
                                            <tr>
                                                ...
                                                <th scope="col" className="color-right-resp">
                                                    Renk
                        </th>
                                        ...
                                        <Droppable droppableId="LocationList">
                                            {(provided) => (
                                                <tbody ref={provided.innerRef}>{locations}</tbody>
                                            )}
                                        </Droppable>
                                    </Table>
                                </DragDropContext>
...
const mapDispatchToProps = (dispatch) => {
    return {
        onInitLocations: (filterData) =>
            dispatch(actions.initLocations(filterData)),
        ...
        updateLocation: (locationId, locationData) =>
            dispatch(actions.updateLocation(locationId, locationData)),
        reorderLocation: (locationsData, startIndex, endIndex) =>
            dispatch(actions.reorderLocation(locationsData, startIndex, endIndex)),
