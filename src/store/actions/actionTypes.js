...
export const BULKLOCATION_REQUEST = 'USERINFO_REQUEST'; 
export const BULKLOCATION_SUCCESS = 'USERINFO_SUCCESS';  
export const BULKLOCATION_FAILURE = 'USERINFO_FAILURE'; 
